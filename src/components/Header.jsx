...
const Header = ({ image, title, subtitle }) => {
  ...
  return (
    <header className="relative w-full min-h-[50vh] h-[100vh] sm:h-[80vh] overflow-hidden flex flex-col">
      
      <img
        src={image}
        alt="baner"
        className="absolute inset-0 scale-230 sm:scale-100 w-full h-[100vh] sm:h-full object-contain sm:object-cover brightness-50 rotate-90 sm:rotate-0"
      />
